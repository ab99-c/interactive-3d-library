...
const output = `// Generated from the public-domain Arabic work text; do not edit manually.\nexport const HAYY_PAGES = ${JSON.stringify(pages, null, 2)} as const;\nexport const HAYY_PAGE_COUNT = HAYY_PAGES.length;\nexport const toArabicPageNumber = (value: number) => String(value).replace(/[0-9]/g, (digit) => "٠١٢٣٤٥٦٧٨٩"[Number(digit)]);\n`;
fs.writeFileSync("client/src/game/hayy-pages.ts", output);
